...
Rank these channels by relevance to the user's query. Return ALL channel IDs sorted most-relevant first, most relevant first.
Respond ONLY with JSON array: ["uuid1", "uuid2", ...]`;
        ...
        if (Array.isArray(rankedIds) && rankedIds.length > 0) {
          // Reorder based on Claude's ranking
